...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <br />
            <div>
                <asp:Label ID="Label6" runat="server" Text="Genel Not Ortalaması"></asp:Label>
                <asp:TextBox ID="TxtGnot" runat="server" CssClass="form-control" Height="100px" TextMode="MultiLine"></asp:TextBox>
            </div>
             <br />
            <div>
